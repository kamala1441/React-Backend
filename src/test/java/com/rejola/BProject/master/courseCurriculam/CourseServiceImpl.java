...
public class CourseServiceImpl implements CourseService{
	...
	public final CourseSectionRepo courseSectionRepo;
	
	

	public CourseServiceImpl(CourseRepo courseRepo, ModelMapper modelMapper,CourseSectionRepo courseSectionRepo) {
		super();
	...
	@Override
	public ResponseEntity<JsonNode> saveCourseSection(CourseSection courseSection) {
		 courseRepo.save(courseSection);
         return ResponseEntity.ok(ResultBuilder.successJson("Course saved successfully"));
    }
